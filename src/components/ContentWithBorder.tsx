...
function ContentWithBorder({ content, classNames, contentClass }: { content: string; classNames?: string; contentClass?: string }) {
    return (
        <div className={`flex items-center justify-center border-2 border-gradient-section-7  w-[335px] h-[90px] rounded-[20px] px-[16px] py-[48px] text-center xl:w-[220px] xl:h-[217px] ${classNames ? classNames : ""}`}>
