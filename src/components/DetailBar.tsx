...
function DetailBar({ title, content }: { title: string, content: string }) {
    return (
        <div className='flex flex-col justify-center items-center w-[300px] h-[298px] gap-6 rounded-[16px] px-6 detail-bar-1 xl:rounded-[300px] xl:h-[136px] xl:w-[1250px] 2xl:w-[1440px] xl:flex-row border-none '>
